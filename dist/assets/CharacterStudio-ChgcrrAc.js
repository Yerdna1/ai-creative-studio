function t(){const e=document.createElement("div");return e.className="w-full h-full flex flex-col items-center justify-center bg-app-bg relative p-4 md:p-6 overflow-y-auto",e.innerHTML=`
