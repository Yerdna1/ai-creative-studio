                ...
                <div class="space-y-2">
                    ${[1,2,3,4,5].map(t=>`
                        <div class="flex items-center gap-4 bg-black/40 border border-white/5 rounded-xl p-4">
                            <div class="w-16 h-10 bg-gradient-to-br from-red-500/20 to-orange-500/20 rounded-lg flex items-center justify-center text-white font-bold">${t}</div>
                            <div class="flex-1">
                                <p class="text-white text-sm font-medium">Shot ${t}</p>
